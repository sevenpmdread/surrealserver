...
const {getanswerforquestionforuser,getAnswersforId,createContrast,getAnswersforCategory,createAnswer,createVentAnswer,getresponsesbyuser,getAnswer} = require('../controllers/Answer')
...
router.route('/responseforquestion').post(getanswerforquestionforuser)
